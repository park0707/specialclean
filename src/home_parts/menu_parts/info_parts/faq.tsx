...
const FAQ_DATA: FaqItem[] = [
  ...
  },
  {
    ...
    answer: '클린매칭은 실재하는 사업체 정보만 제공하기 위해 가입 신청 시 입력된 사업자등록번호의 개폐업 상태를 기본적으로 확인합니다. 다만, 개별 현장에 필요한 세부 인허가(소독업 신고증, 폐기물 처리 허가 등) 서류의 실물 검증 및 법적 준수 여부는 개별 업체가 직접 관리하므로, 서비스 계약 진행 시 업체의 소개 내용 및 제공된 태그 정보를 바탕으로 상세히 확인해 주시기 바랍니다.'
  },
  {
    id: 'partner-1',
    category: '업체 파트너 안내',
  ...
  },
  {
    ...
    answer: '클린매칭은 파트너가 등록하는 소개 정보와 태그의 신뢰성을 위해 사업자등록 상태를 기본 확인합니다. 특수 청소를 수행하는 파트너는 관계 법령(감염병예방법, 폐기물관리법 등)에 따른 소독업 신고 및 폐기물 수집·운반 허가 요건을 준수해야 할 의무가 있으며, 허위 태그 등록 시 임의 조치될 수 있습니다. 현재 별도의 증빙 서류 제출이나 정밀 실물 검사 단계는 운영하고 있지 않으며, 파트너의 자율적인 법적 준수와 고객의 2차 확인을 기반으로 운영됩니다.'
  },
  {
    id: 'refund-1',
    category: '예약 및 환불',
